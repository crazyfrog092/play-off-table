...
function finishDrag(e) {
  ...
  if (dropElem) {
    const drag = {
      id: dragObject.elem.dataset.id,
      name: dragObject.elem.dataset.name,
    };
    const drop = {
      id: dropElem.dataset.id,
      name: dropElem.dataset.name,
      number: dropElem.dataset.number,
    };
    store.commit('dropElemToGrid', { drag, drop });
